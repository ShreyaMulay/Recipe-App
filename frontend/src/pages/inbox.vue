...
const sentOn=ref()
const mailHtml1 = ref()
const attachmentList1=ref()
watch(selectedConversationId, () => {
  console.log(selectedConversationId.value)
  if(selectedConversationId.value == 1)
  {
    title.value= "Important project review next thursday"
    sentOn.value="Oct 21 2020, at 02:33pm"
    sendEmail.value="melany@vuero.io"
    ...
    attachmentList1.value = [
      { name: 'budget_draft.xlsx', icon: 'feather:arrow-down' },
      { name: 'project-notes.docx', icon: 'feather:arrow-down' }
    ];

  }
  else if(selectedConversationId.value == 2)
  {
    title.value= "I couldn't catch up on last time's dinner"
    sentOn.value="Oct 22 2020, at 09:17am"
    sendEmail.value="jonathan@vuero.io"
    ...
    attachmentList1.value = [
      { name: 'presentation.ppt', icon: 'feather:arrow-down' },
      { name: 'venue-1.jpg', icon: 'feather:arrow-down' },
      { name: 'venue-2.jpg', icon: 'feather:arrow-down' },
      { name: 'venue-3.jpg', icon: 'feather:arrow-down' }

    ];

  }
  else if(selectedConversationId.value == 3)
  {
    title.value= "Don't forget to send me those budget notes"
    sentOn.value="Oct 20 2020, at 08:43am"
    sendEmail.value="greta@vuero.io"
    mailHtml1.value = `
          <p>Hi Erik,</p>
          <p>
...
const changeSorting = (criteria: 'name' | 'date', order: 'asc' | 'desc') => {
    ...
    <div class="inbox-wrapper">
      <div class="wrapper-inner">
                ...
                <ul>
                  <li>
                    <a
                      ...
                      @click="updateInbox++;activeTab = 'inbox'"
                    >
                  ...
                  <li>
                    <a
                      ...
                      @click="updateInbox++;activeTab = 'drafts'"
                    >
                      <i
                        aria-hidden="true"
                        class="iconify"
                  ...
                  <li>
                    <a
                      ...
                      @click="updateInbox++;activeTab = 'sent'"
                    >
                  ...
                  <li>
                    <a
                      ...
                      @click="updateInbox++;activeTab = 'trash'"
                    >
                      <i
                        aria-hidden="true"
                        class="iconify"
                  ...
                  <li>
                    <a
                      ...
                      @click="updateInbox++;activeTab = 'span'"
                    >
                      <i
                        aria-hidden="true"
                        class="iconify"
                  ...
                  <li>
                    <a
                      :class="[activeTab === 'bookmarked' && 'is-active']"
                      tabindex="0"
                      @keydown.space.prevent="activeTab = 'bookmarked'"
                      @click="updateInbox++;activeTab = 'bookmarked'"
                    >
        ...
        <div class="inbox-messages">
              ...
              >
                ...
                <div class="dropdown-menu">
                  <div class="dropdown-content">
                    ...
                    <a class="dropdown-item" @click="changeSorting('name','asc')">
                      <i
                        aria-hidden="true"
                        class="iconify"
                    ...
                    <a class="dropdown-item" @click="changeSorting('date','asc')">
          ...
          <div class="messages-list has-slimscroll">
            ...
            <InboxMessagesList
              ...
              v-model:sortBy="sortBy"  v-model:sortOrder="sortOrder"
        ...
        <Message1
          ...
          :sendEmail="sendEmail"
          :sentOn="sentOn"
          :mailContent="mailHtml1"
          :attachments="attachmentList1"
          @bookmark-id="bookmarkMessage"
        />
